...
const CODES = [
  ...
  { id: 57, category: "Venting", title: "Combustion air — confined space requirements", titleEs: "Aire de combustión — requisitos en espacio confinado", code: "IFGC 304 · UPC 507.5 · IPC 2024 G2407", plain: "Gas appliances in confined spaces require dedicated combustion air openings. This is one of the most commonly missed items on final inspections involving mechanical rooms, closets, or utility spaces with gas appliances.\n\nWHAT IS A CONFINED SPACE:\nAny room or enclosure that does not have sufficient volume to provide combustion and dilution air from natural infiltration. The rule of thumb: if the combined BTU rating of all appliances in the space exceeds 50 BTU per cubic foot of room volume, two openings are required.\n\nTWO OPENING METHOD:\n• One opening within 12 inches of the ceiling — supplies combustion air to the burner\n• One opening within 12 inches of the floor — provides dilution air for flue spillage\n• Each opening must be at least 1 square inch of free area per 1,000 BTU/hr of all appliances in the space\n• Minimum opening: 100 square inches for single openings, 100 square inches each for paired openings\n\nCOMMUNICATING WITH INDOOR AIR:\nIf the openings communicate with the interior of the building (not directly to outdoors), double the opening size — indoor air is less oxygen-rich than outdoor air.\n\nCOMMUNICATING WITH OUTDOOR AIR:\nDucts from outside require one horizontal duct within 12 inches of ceiling and one within 12 inches of floor. Size per 1 square inch per 2,000 BTU/hr when connected to outdoors.\n\n🔵 IPC/IFGC CITIES (Dallas, Fort Worth, most of Texas): IFGC Section 304 governs. Standard two-opening method applies.\n🟠 UPC CITIES (Houston, Austin): UPC 507.5 applies. Requirements are essentially identical — two openings, sized by BTU load.\n\nCOMMON FAILS:\n• Single water heater in a closet with no combustion air openings\n• Opening sizes too small for the combined BTU load\n• Openings blocked by shelves, boxes, or louver doors with insufficient free area\n• Alcoves near garages where CO infiltration risk exists — may require sealed combustion appliances\n\nFIELD TIP: Louvered doors do NOT provide free combustion air on their own. Measure the free area of the louvers, not the door frame. Most louvered bifold doors have less free area than assumed.", plainEs: "Los aparatos de gas en espacios confinados requieren aberturas dedicadas de aire de combustión.\n\nDOS ABERTURAS REQUERIDAS:\n• Una abertura dentro de 12 pulgadas del techo\n• Una abertura dentro de 12 pulgadas del piso\n• Cada abertura mínimo 1 pulgada cuadrada por 1,000 BTU/hr de todos los aparatos\n\n🔵 IPC/IFGC y 🟠 UPC: Mismos requisitos básicos de dos aberturas dimensionadas por la carga BTU.\n\nFALLAS COMUNES:\n• Calentador de agua solo en clóset sin aberturas de combustión\n• Aberturas bloqueadas por estantes o puertas de listones\n• Tamaño insuficiente para la carga BTU combinada", tags: ["combustion air", "confined space", "gas appliance", "two openings", "BTU", "mechanical room", "IFGC 304", "UPC 507", "inspection fail", "water heater closet", "louver"] },
  { id: 58, category: "Gas", title: "Gas vent connector — material, slope, and clearances", titleEs: "Conector de ventilación de gas — material, pendiente y espaciado", code: "IFGC 502 · UPC 511 · NFPA 54", plain: "The vent connector is the section of vent pipe from the gas appliance draft hood to the permanent vent or chimney. It is one of the most commonly failed items on final inspections for gas appliances.\n\nAPPROVED MATERIALS:\n• Type B double-wall gas vent connector — required for listed appliances in most new construction\n• Single-wall galvanized sheet metal — permitted in limited applications but has stricter clearance requirements\n• NOT acceptable: PVC, CPVC, flexible aluminum dryer duct, flexible stainless dryer duct\n\nSLOPE REQUIREMENT:\n• Must slope upward toward the vent at minimum 1/4 inch per foot with NO sags or level runs\n• A level or downward-sloping connector causes backdrafting — products of combustion spill into the living space\n• Inspectors probe every connector with a level — no exceptions\n\nLENGTH LIMITS:\n• Single-wall connector: maximum 75% of the vertical vent height OR 10 feet, whichever is less\n• Type B connector: maximum length depends on appliance BTU input and vent sizing — see NFPA 54 tables\n\nCLEARANCES TO COMBUSTIBLES:\n• Type B double-wall connector: 1 inch to combustibles\n• Single-wall connector: 6 inches to combustibles (strictly enforced in attics and framing)\n\nJOINT FASTENING:\n• Every joint must be secured with a minimum of 3 sheet metal screws at each connection\n• Friction-fit joints are NOT acceptable\n• Duct tape, foil tape, and HVAC tape are NEVER acceptable on gas vent connectors\n\n🔵 IPC/IFGC & 🟠 UPC: Both codes require proper slope, listed materials, and fastened joints. Requirements are essentially identical.\n\nCOMMON FAILS:\n• Connector slopes level or downward toward appliance\n• Only 1 or 2 screws at joints instead of 3\n• Connector too long — exceeds 75% of vertical rise\n• Single-wall connector within 6 inches of framing in attic\n• Old connector reused on a new appliance replacement\n\nFIELD TIP: Replace the vent connector whenever you replace the appliance. Old galvanized connectors rust from the inside out from condensation — by the time they look bad on the outside they are already compromised.", plainEs: "El conector de ventilación es la sección de tubo desde el capuchón del aparato de gas hasta la ventilación permanente.\n\nMATERIALES APROBADOS:\n• Conector Tipo B de doble pared — requerido en nueva construcción\n• Chapa galvanizada de pared simple — permitida con restricciones más estrictas\n• NO aceptable: PVC, CPVC, ducto flexible de aluminio\n\nPENDIENTE REQUERIDA: Mínimo 1/4 pulgada por pie hacia arriba — sin caídas ni tramos nivelados.\n\nFASTENERS: Mínimo 3 tornillos de chapa en cada unión.\n\nFALLAS COMUNES: Pendiente incorrecta, solo 1-2 tornillos, conector demasiado largo, conector viejo reutilizado en aparato nuevo.", tags: ["vent connector", "Type B vent", "gas appliance", "slope", "3 screws", "single wall", "clearances", "IFGC 502", "UPC 511", "backdraft", "inspection fail", "water heater", "furnace"] },
  { id: 59, category: "Drainage", title: "P-trap requirements — every fixture must have one", titleEs: "Requisitos del sifón en P — cada accesorio debe tener uno", code: "IPC 1002.1 · UPC 1002.0", plain: "Every plumbing fixture must be equipped with a water seal trap. The P-trap is the most common type and is required at every fixture connection. Missing or improper traps are a top-10 inspection fail statewide.\n\nWHAT A P-TRAP DOES:\nThe P-trap holds a water seal of 2 to 4 inches (depth) that physically blocks sewer gas from entering the living space. The moment the seal is lost — from evaporation, siphoning, or improper installation — there is a direct path for hydrogen sulfide, methane, and other sewer gases into the home.\n\nWATER SEAL DEPTH REQUIREMENT:\n• Minimum seal: 2 inches\n• Maximum seal: 4 inches\n• A trap with less than 2 inches of seal will siphon dry in normal use\n• A trap with more than 4 inches of seal (deep seal trap) is only permitted where specifically required — not as a standard installation\n\nTRAP SIZE MUST MATCH DRAIN SIZE:\n• 1-1/4 inch lavatory — 1-1/4 inch trap minimum\n• 1-1/2 inch sink drain — 1-1/2 inch trap\n• 2 inch shower/floor drain — 2 inch trap\n• Reducing the trap below the drain size is not permitted and a common fail\n\nONE TRAP PER FIXTURE:\n• Each fixture drain must connect to its own individual trap\n• Double-trapping (two traps in series) is prohibited — the second trap air-locks and fails\n• A single trap serving two fixture openings (common under double sinks) is acceptable ONLY if the drain between the two openings does not exceed 30 inches and a proper continuous waste configuration is used\n\nTRAP LOCATION:\n• Trap must be as close to the fixture as possible\n• The vertical distance from the fixture outlet to the trap weir cannot exceed 24 inches\n• Trap must be accessible for cleaning — not buried in a wall without a cleanout\n\n🔵 IPC 1002.1 & 🟠 UPC 1002.0: Both codes require individual traps with 2–4 inch water seals.\n\nCOMMON FAILS:\n• Floor drain installed without a trap — open connection to sewer\n• Double-trap under a kitchen sink — two p-traps in series creates air lock\n• Trap outlet higher than trap inlet — installed backwards\n• Trap crown vent — vent connected at the crown of the trap instead of downstream of the trap weir (IPC 1002.1 prohibits this)\n• Fixture drain drops more than 24 inches before reaching the trap", plainEs: "Cada accesorio de plomería debe tener un sifón con sello de agua.\n\nPROFUNDIDAD DEL SELLO: Mínimo 2 pulgadas, máximo 4 pulgadas.\n\nTAMAÑO: El sifón debe coincidir con el tamaño del drenaje.\n\nUN SIFÓN POR ACCESORIO: El doble sifón está prohibido — el segundo sifón bloquea el aire.\n\nFALLAS COMUNES:\n• Drenaje de piso sin sifón\n• Doble sifón bajo fregadero\n• Sifón instalado al revés\n• La caída de la salida del accesorio excede 24 pulgadas antes del sifón", tags: ["P-trap", "trap", "water seal", "2 inches", "4 inches", "sewer gas", "floor drain", "double trap", "IPC 1002", "UPC 1002", "24 inches", "inspection fail"] },
  { id: 60, category: "Water Supply", title: "Cross-connection control — potable vs. non-potable", titleEs: "Control de conexiones cruzadas — potable vs. no potable", code: "IPC 608 · UPC 603 · TCEQ 30 TAC 290.46", plain: "A cross-connection is any actual or potential connection between potable water and a source of contamination. Cross-connection violations are a TCEQ enforcement issue in Texas — not just a building code violation.\n\nCOMMON CROSS-CONNECTIONS FOUND IN THE FIELD:\n• Submerged inlet on a fill valve (ballcock) — covered in Code #46\n• Garden hose left submerged in a swimming pool, pond, or chemical tank with no backflow protection\n• Chemical injection systems connected to irrigation without an RPZ\n• Boiler fill connections without a backflow preventer\n• Fire sprinkler systems connected to potable supply without a listed backflow preventer\n• Lawn chemical applicators (fertilizer, herbicide) connected to a hose bibb\n• Solar thermal water heaters with non-listed check valves on potable connections\n• Commercial dishwasher supply connected without air gap or backflow device\n• Ice machine supply connected to non-potable water source\n\nTEXAS TCEQ ENFORCEMENT:\nUnder TCEQ 30 TAC Chapter 290, licensed water utilities are required to maintain cross-connection control programs. An unprotected cross-connection can result in service termination. Report to TCEQ Cross-Connection Control: (512) 239-4691.\n\nDEGREES OF HAZARD:\n• High hazard (health risk) — requires RPZ or air gap (physical separation)\n• Low hazard (non-health, aesthetic) — may use double check valve assembly\n• Physical air gap: most reliable protection — a measurable unobstructed vertical distance of at least 2x the pipe diameter (minimum 1 inch) between supply outlet and flood level rim\n\n🔵 IPC 608 & 🟠 UPC 603: Both codes require protection at every cross-connection. TCEQ rules apply statewide regardless of which code the city uses.\n\nFIELD TIP: The most commonly overlooked cross-connection in residential work is the lawn irrigation connection to potable water. PVB minimum for residential, RPZ for commercial. If you are working on irrigation and there is no backflow preventer at all — you are required to install one before the job is complete.", plainEs: "Una conexión cruzada es cualquier conexión entre agua potable y una fuente de contaminación.\n\nCONEXIONES CRUZADAS COMUNES EN EL CAMPO:\n• Manguera sumergida en piscina o estanque químico sin protección\n• Inyección de químicos en irrigación sin RPZ\n• Conexiones de llenado de caldera sin preventor de reflujo\n• Aspersores conectados al suministro potable sin preventor\n\nENFORCEMENT TCEQ: Puede resultar en cancelación del servicio. Reportar al (512) 239-4691.\n\n🔵 IPC 608 y 🟠 UPC 603: Ambos requieren protección en cada conexión cruzada.", tags: ["cross-connection", "backflow", "potable water", "TCEQ", "RPZ", "air gap", "irrigation", "IPC 608", "UPC 603", "high hazard", "contamination", "service termination"] },
  { id: 61, category: "Fixtures", title: "Toilet — flush volume and prohibited flush valves", titleEs: "Inodoro — volumen de descarga y válvulas prohibidas", code: "IPC 2024 419.1 · UPC 402.3 · Texas Water Code", plain: "Toilet flush volume is regulated both by the plumbing code and by the Texas Water Code. Plumbers must know which flush volume applies to the city they are working in.\n\nFLUSH VOLUME BY CODE AND JURISDICTION:\n• Texas Water Code 372: Statewide minimum — all toilets must be 1.6 GPF or less in all commercial and residential new construction. This is a STATE LAW, not just a code — applies everywhere in Texas.\n• IPC 2021 cities (DFW, most of Texas): Maximum 1.6 GPF per flush\n• IPC 2024 cities (Plano, Frisco, Flower Mound, The Colony, Sugar Land, San Antonio, Killeen, McAllen): Maximum 1.28 GPF per flush — the IPC 2024 tightened the limit\n• UPC cities (Houston, Austin): Houston requires 1.28 GPF maximum. Austin requires 1.28 GPF maximum — both cities enforced this before it was required by the IPC 2024.\n\nDUAL FLUSH:\nDual-flush toilets must have both flush modes at or below the maximum. A dual-flush toilet with a 1.6/1.0 GPF setting is acceptable in IPC 2021 cities. In IPC 2024 and UPC cities the full flush must not exceed 1.28 GPF.\n\nPROHIBITED FLUSH VALVES IN RESIDENTIAL:\n• Pressure-assist flush tanks using house supply pressure > 80 PSI must have a pressure-reducing valve on the supply\n• Flushometer valves (commercial style direct-supply flush valves) require minimum 1-inch supply line and minimum 25 PSI flow pressure — cannot be installed on typical 1/2 inch residential supply stubs\n\n🔵 IPC (most of Texas): 1.6 GPF standard, 1.28 in IPC 2024 cities.\n🟠 UPC (Houston, Austin): 1.28 GPF required.\n\nCOMMON FAILS:\n• Installing an old 3.5 GPF toilet from salvage — illegal statewide\n• Flushometer valve on an undersized residential supply line\n• Dual-flush toilet with non-compliant high flush setting in 1.28 GPF cities", plainEs: "El volumen de descarga de inodoros está regulado por el código de plomería y la Ley de Agua de Texas.\n\nPOR LEY ESTATAL (Texas Water Code 372): Máximo 1.6 GPF en toda Texas.\n\nCIUDADES IPC 2024 (Plano, Frisco, etc.) y CIUDADES UPC (Houston, Austin): Máximo 1.28 GPF.\n\nPROHIBIDO: Inodoros de 3.5 GPF de salvamento — ilegales en toda Texas.\n\nFALLAS COMUNES: Inodoro antiguo de alto consumo instalado, válvula flushómetro en línea residencial de 1/2 pulgada.", tags: ["toilet", "flush volume", "1.6 GPF", "1.28 GPF", "Texas Water Code", "IPC 2024", "UPC", "flushometer", "prohibited", "dual flush", "water conservation"] },
  { id: 62, category: "Drainage", title: "Shower pan liner and flood test requirements", titleEs: "Membrana impermeable de ducha y requisitos de prueba de inundación", code: "IPC 417.5 · UPC 408.9", plain: "Shower receptor liners and flood tests are required before any tile or flooring is installed over a custom-built shower pan. This inspection is frequently missed on remodel jobs and results in costly callbacks.\n\nWHEN A LINER IS REQUIRED:\nAny shower receptor that is built on-site (mud bed, mortar bed, or concrete pan) requires a waterproof liner before the finish floor is applied. Pre-formed acrylic, fiberglass, and solid surface shower bases are listed products and do not require a separate liner.\n\nAPPROVED LINER MATERIALS:\n• CPE (Chlorinated Polyethylene) — most common, 40 mil minimum thickness\n• PVC — 40 mil minimum thickness, also very common\n• Lead pan — still permitted but rarely used today\n• Hot-mopped roofing felt — accepted in some UPC jurisdictions (Houston)\n\nINSTALLATION REQUIREMENTS:\n• Liner must extend at least 2 inches above the top of the rough curb\n• Liner must be clamped into the drain assembly — not just laid over the drain\n• No penetrations through the liner except the clamping drain assembly\n• Liner must be completely continuous — no patches, no laps less than 2 inches\n\nFLOOD TEST:\n• The liner must be flood tested BEFORE any tile, mortar, or finish is applied\n• Test: plug the drain and fill to the level of the dam or 2 inches above the liner\n• Hold test: minimum 24 hours — both IPC and UPC require this\n• Inspector or third-party verifier must witness the test in most Texas cities\n• Crossroads, Veritas, and Roadrunner all require witnessed flood tests\n\n🔵 IPC 417.5 (DFW, most Texas): CPE or PVC liner, 40 mil, 2-inch above curb, 24-hour flood test.\n🟠 UPC 408.9 (Houston, Austin): Same requirements. Houston also accepts hot-mopped pan as an approved alternative — common in older Houston construction.\n\nCOMMON FAILS:\n• Tile installed before liner is inspected or flood-tested\n• Liner not clamped into drain assembly — water bypasses the liner at the drain\n• Liner extends less than 2 inches above the curb — fails at the wall-floor junction\n• Flood test held less than 24 hours\n• Liner has pinholes from fasteners driven through during curb construction", plainEs: "Las membranas impermeables en duchas construidas en obra requieren prueba de inundación de 24 horas ANTES de colocar azulejos.\n\nMATERIALES APROBADOS: CPE o PVC de 40 mil de espesor mínimo.\n\nINSTALACIÓN: La membrana debe extenderse al menos 2 pulgadas sobre la solera de la ducha y estar sujetada en el conjunto del drenaje.\n\nPRUEBA DE INUNDACIÓN: Mínimo 24 horas — inspeccionada antes de colocar acabados.\n\nFALLAS COMUNES: Azulejos colocados antes de la inspección, membrana no sujetada en el drenaje, prueba de menos de 24 horas.", tags: ["shower pan", "liner", "CPE", "PVC", "flood test", "24 hours", "40 mil", "curb", "IPC 417", "UPC 408", "tile", "mortar bed", "mud bed", "Veritas", "Crossroads", "inspection fail"] },
  { id: 63, category: "Water Heaters", title: "Tankless water heater installation requirements", titleEs: "Requisitos de instalación de calentador de agua sin tanque", code: "IPC 501 · UPC 501 · NFPA 54", plain: "Tankless (on-demand) water heaters have specific installation requirements that differ from storage tank units. Installation errors are extremely common, especially on gas-fired units.\n\nGAS SUPPLY SIZING — THE #1 FAIL ON TANKLESS:\nA tankless unit requires significantly more gas than a storage tank heater. A typical 199,000 BTU tankless unit requires more than 3x the gas flow of a 40,000 BTU storage tank. The existing gas line from the meter is almost always undersized for a tankless unit in a retrofit.\n\n• 3/4 inch gas line capacity at typical Texas pressures: approximately 100,000 BTU at 20 feet from the meter\n• 1 inch gas line: approximately 200,000 BTU at 20 feet\n• Most Texas homes have 3/4 inch service from the meter — a single high-BTU tankless unit may require upgrading to 1 inch service or running a dedicated 1 inch line\n• Undersized gas supply causes the unit to short-cycle, fault, and fail to heat\n\nVENTING OPTIONS:\n• Category IV sealed combustion (PVC vent): most common for indoor installations — requires sealed PVC or CPVC intake and exhaust duct to outside\n• Direct vent (concentric pipe through wall): approved for through-wall installations\n• Most modern indoor condensing tankless units are CATEGORY IV — DO NOT vent these into a Type B or B-vent system — the acidic condensate will destroy the B-vent liner\n\nWATER CONNECTIONS:\n• Isolation valves required on both hot and cold\n• Service valves with integrated pressure relief bypass required on most premium units\n• Cold supply must have a filter if the unit manufacturer requires it (most do)\n• DO NOT use dielectric unions where the manufacturer specifies direct metallic connections\n\nEXPANSION TANK:\n🔵 IPC: Technically not required for tankless without a storage buffer tank — no stored volume means less thermal expansion\n🟠 UPC (Houston, Austin): Required on ALL closed systems regardless of heater type — tankless included\n\nCOMMON FAILS:\n• Gas supply undersized — unit faults at high demand\n• Category IV exhaust connected into existing B-vent — destroys the vent liner\n• No dedicated cold water filter when manufacturer requires it\n• Unit installed in unconditioned attic without freeze protection in North Texas\n• No condensate drain for condensing models — condensate must drain to an approved location", plainEs: "Los calentadores de agua sin tanque tienen requisitos específicos que difieren de los tanques de almacenamiento.\n\nSUMINISTRO DE GAS — FALLA #1: La mayoría de casas tienen línea de 3/4 pulgada — insuficiente para unidades de alto BTU (199,000 BTU+). Generalmente requiere línea de 1 pulgada dedicada.\n\nVENTILACIÓN CATEGORÍA IV: No conectar al sistema B-vent existente — el condensado ácido destruirá el revestimiento.\n\nFALLAS COMUNES: Línea de gas subdimensionada, escape conectado al B-vent existente, sin filtro de agua cuando el fabricante lo requiere.", tags: ["tankless", "on-demand", "water heater", "gas supply sizing", "Category IV", "PVC vent", "BTU", "expansion tank", "UPC", "freeze protection", "condensate", "inspection fail", "retrofit"] },
  { id: 64, category: "Gas", title: "Gas meter clearances and shutoff requirements", titleEs: "Distancias del medidor de gas y requisitos de cierre", code: "IFGC 404 · UPC 1209 · 49 CFR Part 192", plain: "Gas meter installation and clearance requirements are enforced by the gas utility AND the building department. The plumber is responsible for the building side of the meter — the service line from the meter into the building.\n\nCLEARANCES FROM METER TO IGNITION SOURCES:\n• Minimum 3 feet from any electrical panel, meter socket, or disconnect\n• Minimum 3 feet from any ignition source including AC disconnect, pool equipment, generators\n• Minimum 3 feet from any air intake or opening into the building\n• Minimum 5 feet from any building opening (window or door) that could allow gas accumulation indoors\n• Meters must not be placed under decks, porches, or other covered areas without utility approval\n\nBUILDING SHUTOFF (MANUAL GAS VALVE AT METER):\n• A manual shutoff valve must be accessible within the building at the point of entry of the gas service\n• The building main gas shutoff must be accessible without entering a locked space\n• Utilities often install a utility shutoff at the meter — this is NOT the same as the building main shutoff required by code\n\nGAS PIPING FROM METER TO BUILDING:\n• Outdoor gas piping must be protected against mechanical damage\n• If run along the building exterior, gas pipe must be painted or coated to prevent corrosion\n• Plastic gas pipe (PE) may not extend above grade — the transition to metallic must be made below ground or at the meter connection point\n• Risers from underground PE pipe must be metallic and protected with a yellow warning sleeve\n\n🔵 IFGC CITIES & 🟠 UPC CITIES: Both codes reference the utility regulations (49 CFR Part 192) for the service piping. Building department enforces IFGC/UPC from the meter outlet into the building.\n\nCOMMON FAILS:\n• Electrical panel installed too close to the gas meter — installer moved the panel but not the meter, or vice versa\n• Outdoor AC unit placed within 3 feet of the meter by HVAC trade\n• Building main shutoff valve not accessible from outside in an emergency\n• PE gas riser not sleeved with yellow protective conduit above grade", plainEs: "Los medidores de gas requieren distancias mínimas de fuentes de ignición y paneles eléctricos.\n\nDISTANCIAS MÍNIMAS:\n• 3 pies de cualquier panel eléctrico o fuente de ignición\n• 5 pies de cualquier abertura del edificio\n\nVÁLVULA PRINCIPAL: Debe ser accesible sin entrar a un espacio cerrado.\n\nFALLAS COMUNES: Panel eléctrico instalado muy cerca del medidor, unidad de AC del HVAC dentro de 3 pies del medidor, tubería PE sin manga amarilla sobre el nivel del suelo.", tags: ["gas meter", "clearances", "3 feet", "5 feet", "building shutoff", "PE pipe", "riser", "IFGC 404", "UPC 1209", "electrical panel", "AC unit", "inspection fail"] },
  { id: 65, category: "Drainage", title: "Sewer gas smell — diagnosing and fixing the source", titleEs: "Olor a gas cloacal — diagnóstico y corrección de la fuente", code: "IPC 1002 · IPC 305 · UPC 1002", plain: "Sewer gas complaints are one of the most common service calls in Texas plumbing. The smell is hydrogen sulfide from the sewer system entering the living space. Here is a systematic diagnosis approach.\n\nSEVEN SOURCES OF SEWER GAS — CHECK IN ORDER:\n\n1. DRY TRAP — most common cause:\n• Any fixture not used for 3–6 weeks can lose its trap water seal to evaporation\n• Floor drains, guest bathroom sinks, utility sinks, bar sinks, tubs\n• Fix: run water or install a trap primer / trap seal product on the drain\n\n2. MISSING TRAP PRIMER on floor drains:\n• Floor drains in mechanical rooms, laundry rooms, garage drains evaporate quickly\n• IPC 412.2 and UPC 411.0 require trap primers on floor drains subject to evaporation\n• Fix: Install ASSE 1044 listed trap primer or automatic trap fill device\n\n3. CRACKED OR DAMAGED TRAP:\n• P-trap cracks let the water seal escape — usually visible under the sink\n• Fix: Replace the trap\n\n4. VENTING PROBLEM (positive pressure pushing gas back):\n• Blocked vent stack (leaves, bird nest, ice in the Panhandle, vent cap installed)\n• Inadequate vent system allowing sewer gas to push up through traps\n• Fix: Clear the vent, remove any cap or obstruction\n\n5. FAILED WAX RING ON TOILET:\n• A loose toilet rocks and breaks the wax seal\n• Fix: Pull and reset toilet with new wax ring, secure bolts properly\n\n6. SEWER LINE LEAK UNDER SLAB:\n• Cracked or separated underground drain pipe — requires camera inspection\n• Gas permeates up through the slab at cracks\n• Fix: Camera locate and repair\n\n7. IMPROPER TRAP INSTALLATION:\n• S-trap (prohibited — see Code #43), or crown vent, or other disallowed trap configuration\n• Fix: Properly reconfigure to a vented P-trap\n\nFIELD TIP: Use a smoke test to find the source on persistent or hard-to-locate sewer gas leaks. Smoke test machines inject theatrical smoke into the drain system through the cleanout — smoke visible at any opening identifies the breach point.", plainEs: "El olor a gas cloacal es una de las llamadas de servicio más comunes. El sulfuro de hidrógeno entra al espacio habitable.\n\n7 FUENTES — VERIFICAR EN ORDEN:\n1. Sifón seco — causa más común, especialmente en instalaciones sin uso\n2. Sin cebador de trampa en drenajes de piso\n3. Sifón agrietado\n4. Problema de ventilación — tapa o bloqueo en el venteo\n5. Aro de cera del inodoro fallado\n6. Fuga de tubería bajo la losa\n7. Trampa incorrecta (trampa S u otra configuración prohibida)\n\nCONSEJO: Usar prueba de humo para localizar fugas persistentes.", tags: ["sewer gas", "hydrogen sulfide", "dry trap", "floor drain", "trap primer", "wax ring", "S-trap", "smoke test", "vent blocked", "IPC 1002", "UPC 1002", "service call", "diagnosis"] },
  { id: 67, category: "Drainage", title: "Island sink venting — no wall vent available", titleEs: "Ventilación de fregadero isla — sin ventilación de pared disponible", code: "IPC 912 · UPC 908", plain: "Kitchen island sinks present one of the most common venting challenges in remodel work — there is no wall to run a vent through. Two code-approved solutions exist.\n\nSOLUTION 1 — ISLAND FIXTURE VENT (IPC 912):\nAlso called a \"Chicago loop\" or \"bow vent.\" The drain pipe rises as high as possible inside the cabinet before connecting to the horizontal drain. The vent pipe loops up and over, then down to connect to the drain downstream of the trap. The top of the loop must be above the flood level rim of the sink.\n• IPC 912 permits this configuration\n• The vent connection must be above the trap weir\n• The horizontal vent portion must slope back toward the drain\n\nSOLUTION 2 — AIR ADMITTANCE VALVE (AAV):\n• Install an ASSE 1051 listed AAV inside the island cabinet\n• Must be accessible — inside the cabinet qualifies\n• At least 4 inches of air space above the trap weir\n• Not permitted in Houston or Austin without special approval (UPC jurisdiction)\n\n🔵 IPC CITIES (DFW, most Texas): Both island vent and AAV are accepted.\n🟠 UPC CITIES (Houston, Austin): Island vent loop is the preferred solution. AAV requires verification with local inspector.\n\nCOMMON FAILS:\n• Running a vent under the slab to reach a wall — creates a trap in the vent line if it dips\n• AAV installed in a sealed base cabinet with no air circulation\n• Loop vent top below the flood level rim of the sink — allows siphoning\n\nFIELD TIP: In IPC cities, the AAV under the island cabinet is fast, clean, and passes every time. In Houston or Austin, call the inspector first.", plainEs: "Los fregaderos de isla presentan uno de los desafíos de ventilación más comunes — no hay pared para pasar el venteo.\n\nSOLUCIÓN 1 — VENTEO EN ISLA (IPC 912): La tubería de drenaje sube lo más alto posible antes de conectar al drenaje horizontal. El venteo hace un lazo por encima del nivel de inundación.\n\nSOLUCIÓN 2 — VÁLVULA AAV: Instalada dentro del gabinete, accesible, listada ASSE 1051.\n\n🔵 IPC (DFW): Ambas soluciones aceptadas.\n🟠 UPC (Houston, Austin): El lazo de ventilación es preferido. AAV requiere verificación.", tags: ["island sink", "kitchen island", "AAV", "Chicago loop", "bow vent", "IPC 912", "UPC 908", "no wall vent", "remodel", "venting"] },
  { id: 68, category: "Gas", title: "Black iron pipe — threading, joining, and support", titleEs: "Tubería de hierro negro — roscado, unión y soporte", code: "IFGC 403 · UPC 1210 · ASME B1.20.1", plain: "Black iron pipe (Schedule 40 steel) is the standard material for gas distribution inside buildings in Texas. Proper threading, assembly, and support are checked on every rough-in inspection.\n\nTHREADING REQUIREMENTS:\n• All threads must be cut to ASME B1.20.1 standard taper pipe thread (NPT)\n• Threads must be clean, full, and free of burrs or damage\n• Thread engagement: minimum 3 full threads engaged at every connection\n• Thread sealant: approved pipe dope (paste type) or PTFE tape listed for gas — apply to MALE threads only, never female threads\n• Yellow PTFE tape is rated for gas — white plumber's PTFE tape is NOT approved for gas connections\n\nJOINING:\n• Every assembly must include a union at each appliance connection for serviceability\n• No cast iron fittings on gas systems — steel or malleable iron only\n• Bushings are permitted but hex bushings preferred over face bushings\n• Street elbows permitted in accessible locations\n\nSUPPORT SPACING:\n• 1/2 inch pipe: support every 6 feet\n• 3/4 inch and 1 inch: support every 8 feet\n• 1-1/4 inch and larger: support every 10 feet\n• Horizontal runs must be supported to prevent sag — sag creates low spots that trap condensate\n• Supports must be metal — plastic pipe straps are NOT approved for gas piping\n\n🔵 IFGC CITIES & 🟠 UPC CITIES: Both codes require NPT threads, approved sealant, and proper support spacing.\n\nCOMMON FAILS:\n• White PTFE tape used instead of yellow gas-rated tape\n• Thread sealant applied to female threads — inspector will call it\n• Missing union at appliance connection\n• Plastic pipe straps supporting gas line\n• Sag in horizontal run between supports", plainEs: "La tubería de hierro negro Schedule 40 es el material estándar para distribución de gas interior en Texas.\n\nROSCADO: Cinta PTFE amarilla para gas — la cinta blanca de plomería NO está aprobada para gas. Mínimo 3 hilos completos en cada conexión.\n\nSOPORTE: 1/2\" cada 6 pies, 3/4\" y 1\" cada 8 pies, 1-1/4\" y más grandes cada 10 pies.\n\nFALLAS COMUNES: Cinta blanca en lugar de amarilla, sin unión en la conexión del aparato, abrazaderas plásticas en tubería de gas.", tags: ["black iron", "steel pipe", "NPT", "PTFE tape", "yellow tape", "gas pipe", "threading", "union", "support spacing", "IFGC 403", "inspection fail"] },
  { id: 69, category: "Fixtures", title: "ADA / accessible plumbing fixture requirements", titleEs: "Requisitos de accesorios de plomería ADA / accesibles", code: "IPC 2024 Ch. 4 · ADA Standards · ICC A117.1", plain: "ADA and accessible plumbing requirements apply to all commercial construction and multi-family residential in Texas. Violations are among the most expensive corrections because they often require moving rough-in.\n\nWATER CLOSETS (TOILETS) — ACCESSIBLE:\n• Centerline: 16–18 inches from side wall (NOT 15 inches — that is the standard minimum)\n• Seat height: 17–19 inches above finished floor\n• Clear floor space: 60 inches minimum from side wall, 56 inches from rear wall\n• Flush control: on open side of toilet, maximum 44 inches above floor\n\nLAVATORIES (SINKS) — ACCESSIBLE:\n• Rim height: maximum 34 inches above finished floor\n• Knee clearance: minimum 27 inches high, 30 inches wide, 19 inches deep below the lavatory\n• All exposed drain and supply piping under accessible lavatories must be insulated or otherwise configured to protect against contact — hot pipe burns a user who cannot feel it\n• Faucet controls: lever, push, touch, or automatic — no twist knobs\n\nSHOWERS — ROLL-IN ACCESSIBLE:\n• Minimum 36 x 36 inch transfer shower OR 30 x 60 inch roll-in shower\n• No curb or threshold — flush entry required\n• Folding or removable shower seat required\n• Grab bars: 33–36 inches above floor on back and side walls\n\n🔵 IPC & 🟠 UPC: Both codes adopt ICC A117.1 accessible and usable buildings standard. ADA Standards for Accessible Design apply to all public accommodations and commercial facilities.\n\nCOMMON FAILS:\n• Toilet centerline at 15 inches — correct for standard, fails for accessible\n• No knee clearance under accessible lavatory\n• Exposed hot supply pipe under accessible sink — burn hazard, automatic fail\n• Threshold in accessible shower entry", plainEs: "Los requisitos ADA aplican a toda construcción comercial y residencial multifamiliar en Texas.\n\nINODORO ACCESIBLE: Centro a 16-18 pulgadas de la pared lateral, altura del asiento 17-19 pulgadas.\n\nLAVABO ACCESIBLE: Borde máximo 34 pulgadas del piso, espacio para rodillas de 27\" alto × 30\" ancho. Tubería expuesta debe estar aislada.\n\nFALLAS COMUNES: Centro del inodoro a 15\" (correcto para estándar, falla en accesible), sin espacio para rodillas, tubería caliente expuesta bajo lavabo accesible.", tags: ["ADA", "accessible", "ICC A117.1", "toilet centerline", "knee clearance", "lavatory", "roll-in shower", "grab bars", "commercial", "multi-family", "inspection fail"] },
  { id: 70, category: "Water Supply", title: "Pipe insulation requirements — hot and cold", titleEs: "Requisitos de aislamiento de tubería — caliente y fría", code: "IPC 2024 607.2 · IECC · Texas Energy Code", plain: "Pipe insulation is required by both the plumbing code and the energy code. It is commonly missed on final inspections, especially in attics and crawl spaces.\n\nHOT WATER PIPE INSULATION:\n• All hot water supply piping must be insulated to reduce heat loss\n• Texas Energy Code (based on IECC): minimum R-3 insulation on first 8 feet of hot water pipe from the water heater\n• Pipes 3/4 inch and larger: insulate entire length in unconditioned spaces (attics, crawl spaces, garages)\n• Recirculation systems: ALL piping must be insulated — no exceptions\n• Insulation must be continuous — no gaps at hangers or supports\n\nCOLD WATER PIPE INSULATION:\n• Cold water pipes in unconditioned attics subject to freezing must be insulated\n• North Texas (DFW, Amarillo, Lubbock, Wichita Falls): freeze protection required on attic supply lines — minimum 1 inch foam insulation\n• The February 2021 winter storm Uri failures were largely caused by uninsulated attic supply lines\n\nFREEZE PROTECTION BEYOND INSULATION:\n• Attic supply lines in North Texas should also have heat tape as backup\n• Ball valves to isolate and drain exterior hose bibbs in freeze-prone areas\n• Pressure-activated freeze relief valves on outdoor fixtures\n\n🔵 IPC 2024 607.2 & Texas Energy Code: Hot water pipe insulation required. Energy code may require additional insulation levels beyond base plumbing code.\n\nCOMMON FAILS:\n• Hot water pipes in attic with no insulation — energy code violation AND freeze risk\n• Insulation installed but gaps at every hanger — defeats the purpose\n• Recirculation return line not insulated\n• No freeze protection on attic lines in North Texas", plainEs: "El aislamiento de tuberías es requerido por el código de plomería y el código de energía.\n\nTUBERÍA DE AGUA CALIENTE: Mínimo R-3 en los primeros 8 pies desde el calentador. Tuberías de 3/4\" y más grandes completamente aisladas en espacios no acondicionados.\n\nPROTECCIÓN CONTRA CONGELAMIENTO: Las líneas en el ático en el norte de Texas deben estar aisladas — La tormenta de febrero 2021 demostró las consecuencias de no hacerlo.", tags: ["pipe insulation", "R-3", "freeze protection", "attic", "Texas Energy Code", "IECC", "recirculation", "heat tape", "Uri", "North Texas", "IPC 607"] },
  { id: 71, category: "Drainage", title: "Sanitary vs. storm sewer — cross-connection prohibition", titleEs: "Alcantarillado sanitario vs. pluvial — prohibición de conexión cruzada", code: "IPC 1101.2 · UPC 1101.2", plain: "Connecting a sanitary sewer line to a storm sewer (or vice versa) is one of the most serious code violations in Texas plumbing — it is also a TCEQ environmental violation.\n\nWHAT IS THE DIFFERENCE:\n• Sanitary sewer: carries wastewater from toilets, sinks, showers, and appliances to the municipal treatment plant\n• Storm sewer: carries rainwater runoff from streets, parking lots, and roof drains directly to creeks, rivers, and waterways — UNTREATED\n• Connecting sanitary waste to the storm system discharges raw sewage to waterways — illegal under federal Clean Water Act and TCEQ rules\n\nWHERE CROSS-CONNECTIONS HAPPEN:\n• Roof drains mistakenly connected to sanitary stack instead of storm system\n• Floor drains in parking garages connected to sanitary instead of storm (or oil-water separator)\n• Area drains and trench drains in commercial kitchens — must connect to grease interceptor then sanitary, NOT storm\n• Condensate drain lines — must connect to sanitary system, never directly to storm\n\nIDENTIFYING WHICH SYSTEM IS WHICH:\n• In most Texas municipalities, the two systems are completely separate underground\n• Cleanout caps are sometimes color-coded — verify with the utility\n• Storm inlets are typically in streets and parking lots; sanitary cleanouts are at building perimeters\n• When in doubt — call the city utility department before making any connection\n\n🔵 IPC 1101.2 & 🟠 UPC 1101.2: Explicitly prohibit connecting sanitary drainage to storm drainage.\n\nFIELD TIP: On commercial sites with both systems present, always trace the pipe to its termination before connecting anything. A wrong connection on a commercial job can trigger a TCEQ enforcement action and a Stop Work Order.", plainEs: "Conectar el alcantarillado sanitario al pluvial es una de las violaciones más graves — también es una violación ambiental de TCEQ.\n\nDIFERENCIA: El sanitario va a la planta de tratamiento. El pluvial va DIRECTAMENTE a ríos y arroyos sin tratamiento.\n\nDÓNDE OCURRE: Drenajes de techo conectados incorrectamente al bajante sanitario, drenajes de piso en estacionamientos, líneas de condensado conectadas al sistema pluvial.", tags: ["sanitary sewer", "storm sewer", "cross-connection", "TCEQ", "roof drain", "condensate", "IPC 1101", "UPC 1101", "environmental violation", "Clean Water Act", "commercial"] },
  { id: 72, category: "Gas", title: "LP gas (propane) vs. natural gas — key differences", titleEs: "Gas LP (propano) vs. gas natural — diferencias clave", code: "IFGC 401 · NFPA 58 · UPC 1200", plain: "LP gas (propane) and natural gas systems look similar but have critical differences that affect code compliance, equipment compatibility, and safety. Many service calls involve equipment connected to the wrong gas type.\n\nKEY PHYSICAL DIFFERENCES:\n• Natural gas: lighter than air — leaks rise and dissipate at ceiling level\n• LP/Propane: HEAVIER than air — leaks settle to the floor and accumulate in low spots, pits, and basements. This makes LP significantly more dangerous in enclosed spaces.\n• LP requires a different orifice size and regulator than natural gas — appliances are NOT interchangeable without conversion\n\nPRESSURE DIFFERENCES:\n• Natural gas distribution pressure: typically 0.25 PSI (7 inches water column) at the appliance\n• LP distribution pressure: typically 0.5 PSI (11 inches water column) at the appliance — twice natural gas\n• Using an LP appliance on natural gas without conversion = insufficient heat output\n• Using a natural gas appliance on LP without conversion = dangerous overfiring, soot, and carbon monoxide\n\nLP-SPECIFIC REQUIREMENTS:\n• LP tanks must be located a minimum of 10 feet from building openings, ignition sources, and property lines\n• Underground LP piping must be polyethylene (PE) or protected steel\n• LP regulators must be sized for the total connected BTU load\n• Excess flow valves required on all LP service connections per NFPA 58\n• LP systems in buildings must have emergency shutoff within 6 feet of appliances\n\nRURAL TEXAS NOTE:\nMost rural Texas properties not served by natural gas utilities use LP. Hill Country, East Texas rural, and West Texas properties commonly run entire homes on LP. Always confirm which fuel type before ordering appliances or parts.\n\n🔵 IFGC CITIES & 🟠 UPC CITIES: Both codes address LP separately. NFPA 58 governs LP storage and handling statewide.", plainEs: "El gas LP (propano) y el gas natural tienen diferencias críticas de seguridad y código.\n\nDIFERENCIA CLAVE: El gas natural es más liviano que el aire y sube. El LP es MÁS PESADO que el aire y se acumula en el piso — mucho más peligroso en espacios cerrados.\n\nPRESIÓN: El LP opera al doble de presión que el gas natural. Los aparatos NO son intercambiables sin conversión.\n\nTEXAS RURAL: La mayoría de propiedades rurales usan LP. Siempre confirmar el tipo de combustible antes de ordenar piezas o aparatos.", tags: ["LP gas", "propane", "natural gas", "NFPA 58", "orifice", "regulator", "heavier than air", "rural Texas", "conversion", "IFGC 401", "excess flow valve"] },
  { id: 73, category: "Water Supply", title: "Backflow preventer testing and certification requirements", titleEs: "Prueba y certificación de preventores de reflujo", code: "IPC 312.10 · TCEQ 30 TAC 290.46(j)", plain: "Installed backflow prevention assemblies must be tested at installation and annually thereafter. This is a TCEQ requirement that applies statewide — not just a building code requirement.\n\nWHO CAN TEST:\n• Only a TCEQ-licensed backflow prevention assembly tester (BPAT) can perform and certify tests\n• The plumber who installs the assembly is NOT automatically qualified to certify the test unless they hold the BPAT license\n• BPAT license is separate from the plumber's license — requires additional exam and field testing\n\nWHAT MUST BE TESTED:\n• All RPZ (Reduced Pressure Zone) assemblies — annual test required\n• All Double Check Valve assemblies (DCVA) — annual test required\n• Pressure Vacuum Breakers (PVB) — tested at installation; some utilities require annual\n• Single check valves and atmospheric vacuum breakers do NOT require annual certified testing\n\nTEST REPORTING:\n• Test results must be submitted to the local water utility within 10 days of testing\n• Water utilities are required by TCEQ to maintain records of all backflow assembly tests\n• Failed assemblies must be repaired or replaced and retested before the water service resumes\n\nFIELD REALITY IN TEXAS:\n• Many commercial properties are out of compliance on annual testing — a major liability\n• If you install a backflow assembly and don't provide the customer with the annual testing requirement in writing, you may share liability for any contamination event\n\n🔵 IPC 312.10 & TCEQ 30 TAC 290.46(j): Annual testing required. TCEQ enforces statewide.\n\nFIELD TIP: Always provide the customer with the name and contact of a local BPAT tester when you install any testable backflow assembly. Document it on your invoice.", plainEs: "Los ensambles de prevención de reflujo instalados deben probarse al instalar y anualmente después.\n\nQUIÉN PUEDE PROBAR: Solo un probador de preventores de reflujo con licencia TCEQ (BPAT). El plomero instalador no puede certificar la prueba sin la licencia BPAT adicional.\n\nINFORME: Los resultados deben enviarse a la empresa de agua dentro de 10 días.\n\nCONSEJO: Siempre proporciona al cliente el contacto de un probador BPAT local cuando instales cualquier preventor.", tags: ["backflow testing", "BPAT", "annual test", "RPZ", "DCVA", "TCEQ", "IPC 312.10", "certification", "water utility", "commercial", "liability"] },
  { id: 74, category: "Fixtures", title: "Kitchen sink — minimum size and drain requirements", titleEs: "Fregadero de cocina — tamaño mínimo y requisitos de drenaje", code: "IPC 407.2 · UPC 407.0", plain: "Kitchen sinks have specific minimum size, drain, and installation requirements that are frequently overlooked on remodel jobs.\n\nMINIMUM SINK SIZE:\n• Residential kitchen sink: no specific minimum size in the IPC or UPC base code — but local health codes for food prep facilities have minimums\n• Commercial kitchen: three-compartment sink required for manual warewashing — each compartment minimum 12 inches wide, 12 inches long, 6 inches deep\n\nDRAIN REQUIREMENTS:\n• Kitchen sink drain: minimum 1-1/2 inch drain connection\n• Garbage disposal drain: minimum 1-1/2 inch — same size as standard drain\n• Double bowl sinks: both bowls must drain through a single 1-1/2 inch continuous waste to the trap, OR each bowl may have its own trap if space allows\n• The continuous waste between a double bowl must not exceed 30 inches from bowl to bowl\n• Drain tailpiece: minimum 1-1/2 inch, must be smooth bore — corrugated accordion-style tailpieces are NOT code approved (they trap grease and debris)\n\nGARBAGE DISPOSAL:\n• Must be connected with a strain body — not just a rubber boot\n• Dishwasher drain must enter the disposal at the inlet port or at the sink drain above the trap — never below the trap\n• Disposal electrical: must have dedicated 20-amp circuit with accessible switch\n\n🔵 IPC 407.2 & 🟠 UPC 407.0: Both codes set 1-1/2 inch minimum drain for kitchen sinks.\n\nCOMMON FAILS:\n• Accordion corrugated tailpiece used — not code approved, traps grease\n• Dishwasher drain connected below the trap instead of at the disposal inlet\n• Continuous waste between double bowl exceeds 30 inches", plainEs: "Los fregaderos de cocina tienen requisitos específicos de drenaje frecuentemente ignorados en remodelaciones.\n\nDRENAJE: Mínimo 1-1/2 pulgada. Los tubos corrugados tipo acordeón NO están aprobados por código — atrapan grasa.\n\nFREGADERO DOBLE: El desagüe continuo entre los dos compartimientos no debe exceder 30 pulgadas.\n\nFALLAS COMUNES: Tubo corrugado acordeón, drenaje del lavavajillas conectado debajo del sifón.", tags: ["kitchen sink", "1-1/2 inch drain", "continuous waste", "garbage disposal", "accordion tailpiece", "corrugated", "dishwasher drain", "double bowl", "IPC 407", "UPC 407", "inspection fail"] },
  { id: 75, category: "Drainage", title: "Condensate drain — HVAC and equipment requirements", titleEs: "Drenaje de condensado — requisitos de HVAC y equipos", code: "IPC 314 · IRC M1411.3", plain: "HVAC condensate drain lines are a plumbing code item that falls at the intersection of plumbing and mechanical — and gets missed on inspections because each trade assumes the other handled it.\n\nWHAT REQUIRES A CONDENSATE DRAIN:\n• Air handler units and evaporator coils\n• Mini-split indoor units\n• Tankless water heater condensate (Category IV)\n• Commercial refrigeration equipment\n• Dehumidifiers connected to the drain system\n\nDRAIN LINE REQUIREMENTS:\n• Minimum 3/4 inch PVC drain line from the primary drain pan\n• Must slope to drain — no level runs, no traps (condensate drain lines must NOT be trapped)\n• Must terminate at an approved location: floor drain, utility sink, laundry standpipe, outdoors\n• Cannot terminate in a concealed space, attic, or wall cavity\n• Cannot connect to a sanitary drain downstream of a trap — must connect upstream or to an indirect waste\n\nSECONDARY (OVERFLOW) DRAIN:\n• Required whenever the primary drain pan is in a location where overflow could damage the structure (attic, upstairs mechanical closet)\n• Secondary drain must terminate in a visible location — typically over a window or door so the homeowner notices the drip\n• In Texas, many inspectors require a float switch shutoff on attic air handlers as an alternative to a secondary drain line\n\n🔵 IPC 314 CITIES & 🟠 UPC CITIES: Both require secondary overflow protection for units in locations where drainage could cause structural damage.\n\nCOMMON FAILS:\n• Primary condensate drain has a trap installed — condensate cannot drain through a trap\n• No secondary drain on attic air handler\n• Secondary drain terminates in attic instead of a visible location\n• Condensate drain connected to storm sewer instead of sanitary", plainEs: "Las líneas de drenaje de condensado del HVAC son un elemento del código de plomería frecuentemente ignorado.\n\nREQUISITOS: Mínimo 3/4 pulgada PVC, con pendiente, SIN sifón — las líneas de condensado NO deben tener sifón.\n\nDRENAJE SECUNDARIO: Requerido cuando el manejador de aire está en el ático. Debe terminar en un lugar visible — típicamente sobre una ventana o puerta.\n\nFALLAS COMUNES: Sifón instalado en la línea de condensado, sin drenaje secundario en manejador de ático, drenaje secundario que termina en el ático.", tags: ["condensate drain", "HVAC", "air handler", "secondary drain", "overflow", "3/4 inch", "no trap", "attic", "float switch", "IPC 314", "IRC M1411", "inspection fail"] },
  { id: 76, category: "Water Supply", title: "Galvanized pipe — when to replace, not repair", titleEs: "Tubería galvanizada — cuándo reemplazar en lugar de reparar", code: "IPC 605 · UPC 604", plain: "Galvanized steel pipe was the standard water supply material in Texas homes built before approximately 1970. It has a service life of 40–70 years and is past that in most existing homes. This is one of the most important service call topics for Texas plumbers.\n\nWHY GALVANIZED FAILS:\n• The zinc coating corrodes from the inside out — the exterior may look acceptable while the interior is completely blocked\n• Corrosion products (rust and mineral deposits) build up on interior walls, progressively reducing flow\n• Low water pressure at fixtures in older homes is most often caused by corroded galvanized mains\n• Pinhole leaks develop first at threaded connections and fittings, then along straight runs\n\nWHEN YOU SHOULD NOT REPAIR — REPLACE:\n• Any galvanized pipe over 50 years old should be replaced, not repaired\n• If you cut into a galvanized line and the interior wall thickness is less than 1/16 inch — replace the run\n• If you find one pinhole leak in galvanized, there will be more within 2–5 years — advise replacement\n• Orange or brown water from any fixture = corroded galvanized line — water quality issue and health concern\n\nCODE STATUS OF GALVANIZED:\n• New galvanized steel pipe is NOT permitted for new water supply installations under IPC or UPC\n• Existing galvanized systems are grandfathered for as long as they function without a health hazard\n• If you open walls for ANY reason on a galvanized system, the exposed section must be brought to current code material standards\n\nREPLACEMENT MATERIALS:\n• PEX-A or PEX-B (most common replacement in Texas)\n• Type L copper\n• CPVC (permitted but less common in Texas)\n\nFIELD TIP: When bidding a remodel on a pre-1970 Texas home, always include a galvanized inspection and disclose the pipe condition in writing. Galvanized failure during or after a remodel is a common source of contractor disputes.", plainEs: "La tubería galvanizada fue el estándar en casas de Texas construidas antes de ~1970 y tiene vida útil de 40-70 años.\n\nPOR QUÉ FALLA: La corrosión interior reduce el flujo progresivamente. La tubería puede verse bien por fuera mientras está completamente obstruida por dentro.\n\nCUÁNDO REEMPLAZAR (NO REPARAR): Más de 50 años, espesor interior menor de 1/16\", primera fuga de pinhole, agua naranja o marrón.\n\nCÓDIGO: La tubería galvanizada nueva NO está permitida para nuevas instalaciones bajo IPC o UPC.", tags: ["galvanized pipe", "old pipe", "replacement", "low pressure", "orange water", "pre-1970", "pinhole leak", "IPC 605", "UPC 604", "remodel", "service call", "Texas homes"] },
  { id: 66, category: "Water Supply", title: "Minimum water supply pressure at fixtures", titleEs: "Presión mínima de suministro de agua en accesorios", code: "IPC 604.6 · UPC 601.2", plain: "Water supply systems must maintain minimum pressure at every fixture under peak demand conditions. Low pressure is not just an inconvenience — it is a code violation.\n\nMINIMUM PRESSURE AT FIXTURES:\n• 8 PSI minimum at every plumbing fixture under peak simultaneous demand\n• Some fixtures require higher minimums: flush valve water closets require 25 PSI minimum flow pressure\n• Certain shower valves (thermostatic) require manufacturer-specified minimum inlet pressure — commonly 20–45 PSI\n\nMAXIMUM STATIC PRESSURE:\n• 80 PSI maximum at the point of service — PRV required when exceeded (see Code #53)\n\nFLOW PRESSURE vs. STATIC PRESSURE:\n• Static pressure: measured when no water is flowing — what a gauge reads at the hose bibb\n• Flow pressure (residual pressure): measured while fixtures are operating — always lower than static\n• Code requires 8 PSI minimum under FLOW conditions — not just static\n\nCOMMON CAUSES OF LOW PRESSURE:\n• Undersized service line from the meter (see Code #56) — permanent fix requires upsizing\n• Undersized interior distribution piping — common in older homes with 1/2 inch mains\n• Partially closed PRV — set too low, needs adjustment\n• Corroded galvanized pipe — interior corrosion reduces flow area significantly\n• PRV failed closed — needs replacement\n• Clogged aerators and shower heads — fix at the fixture, not the supply system\n\nPIPE SIZING FOR PRESSURE MAINTENANCE:\n• Interior water distribution must be sized to maintain minimum pressure at peak demand\n• IPC 2024 Section 604 and UPC 610 provide sizing tables — use them for new installations\n• In older homes, adding fixtures without upsizing the main distribution is a common cause of failing pressure at distant fixtures\n\n🔵 IPC 604.6 (DFW, most of Texas): 8 PSI minimum under simultaneous demand, 80 PSI maximum.\n🟠 UPC 601.2 (Houston, Austin): Same minimums and maximums.\n\nFIELD TIP: Test pressure at the hose bibb with a $15 gauge before starting any fixture work on an older home. Document static pressure. If it is below 45 PSI static, warn the customer — the supply infrastructure may need attention before adding fixtures.", plainEs: "Los sistemas de suministro de agua deben mantener presión mínima en cada accesorio bajo demanda máxima.\n\nPRESIÓN MÍNIMA: 8 PSI en cada accesorio bajo demanda simultánea. Válvulas flushómetro: 25 PSI mínimo.\n\nPRESIÓN MÁXIMA ESTÁTICA: 80 PSI — requiere PRV si se excede.\n\nCAUSAS COMUNES DE BAJA PRESIÓN: Línea de servicio subdimensionada, tubería galvanizada corroída, PRV ajustada muy baja o fallada.\n\nCONSEJO: Probar presión en la toma de manguera antes de cualquier trabajo en casas antiguas.", tags: ["water pressure", "minimum pressure", "8 PSI", "80 PSI", "flow pressure", "static pressure", "PRV", "flush valve", "25 PSI", "IPC 604", "UPC 601", "low pressure", "undersized pipe", "galvanized"] },
];

// ─── JURISDICTIONS (abbreviated — same as before, keeping key cities) ─────────
const JURISDICTIONS = {
  "Allen": { code: "IPC 2021", population: "107K", region: "North Texas (DFW)", amendments: ["NCTCOG regional amendments apply", "All permits through CSS (Citizen Self-Service) portal before work begins", "Call (214) 509-4130 between 8–9 AM on day of inspection to get time window", "Cancel before 8:30 AM: call (214) 509-4130 | After 8:30 AM: use CSS or IVR", "IVR 24-hour hotline: (844) 381-8759", "Backflow prevention required — irrigation backflow tester must be licensed", "Virtual inspections available — schedule at inspections.oncamino.com/allen-tx"], inspector: "Allen Building & Permitting", phone: "(214) 509-4130", directLine: "(214) 509-4130", scheduleHours: "8–9 AM day of inspection for time window | IVR 24hrs: (844) 381-8759", permitRequired: true, permitUrl: "cityofallen.org/departments/community_development/building_and_permitting/index.php", staffDirectory: "cityofallen.org/departments/community_development/building_and_permitting/index.php", inspectorContacts: [{ name: "Building & Permitting Main", title: "Permits, Inspections, Registration", office: "(214) 509-4130", email: "permits@allentx.gov" }, { name: "Plan Review Questions", title: "Add/Remove Inspection from Workflow", office: "(214) 509-4130", email: "bpplanreview@allentx.gov" }, { name: "IVR Hotline", title: "24-Hour Schedule/Cancel/Status", office: "(844) 381-8759", email: "" }, { name: "Virtual Inspection Scheduling", title: "Video inspection option available", office: "(214) 509-4130 or 4132 by 3PM prior day", email: "" }], thirdParty: ["Crossroads Inspections", "Master Code", "Bureau Veritas"] },
  "Amarillo": { code: "IPC 2021", population: "200K", region: "Texas Panhandle", amendments: ["Roof vents must terminate with a listed and labeled cap per manufacturer specs", "Clothes dryer exhaust: no screens at termination, backdraft damper required", "Pressure test required — document start and end PSI", "Review Ordinance 7101 for all local amendments", "Schedule inspections via MGO portal: 866-957-3764"], inspector: "Amarillo Building Safety", phone: "(806) 378-3041", directLine: "(806) 378-3041", scheduleHours: "Mon–Fri 7:30AM–5PM | Schedule via MGO: (866) 957-3764", permitRequired: true, permitUrl: "amarillo.gov/building-safety", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Austin": { code: "UPC 2021 ⚠", population: "978K", region: "Central Texas", amendments: ["⚠ Austin uses the UPC — NOT the IPC", "⚠ Austin also uses the 2024 IBC and 2024 IRC for building — but PLUMBING is UPC", "Reclaimed water rough-in required on all new construction", "Low-flow fixtures: 1.28 GPF max on toilets", "Green building code overlay applies in designated zones", "After-hours inspections available — contact assigned inspector directly", "Austin Water: water meter inspections (610/611) — call (512) 972-1000 option 3"], inspector: "Austin Development Services — Building Inspections", phone: "(512) 974-2000", directLine: "(512) 974-9405", scheduleHours: "Schedule via AB+C Portal or IVR (512) 974-9405 | Inspections 24hrs after scheduling", permitRequired: true, permitUrl: "austintexas.gov/page/building-inspections", staffDirectory: "austintexas.gov/page/building-inspections — use Find Your Inspector tool", inspectorContacts: [{ name: "Building Inspections Email", title: "General Questions & Emergency Inspections", office: "(512) 974-2000", email: "building.inspections@austintexas.gov" }, { name: "IVR Scheduling Line", title: "Schedule/Cancel/Status 24hrs", office: "(512) 974-9405", email: "" }, { name: "Austin 3-1-1", title: "General City Services", office: "311 or (512) 974-2000", email: "" }, { name: "Austin Water - Taps Office", title: "Water Meter Inspections (610/611)", office: "(512) 972-1000 option 3", email: "AWTaps@austintexas.gov" }, { name: "Hyatt Dunn", title: "After-Hours Electrical Shutdown Inspections", office: "Contact via building.inspections@austintexas.gov", email: "" },
      { name: "Trebor Brown **", title: "Commercial Plumbing & Mechanical Inspector", office: "(512) 974-2946", mobile: "(512) 228-1096", email: "trebor.brown@austintexas.gov" },
      { name: "Chris Phillips *", title: "Commercial Plumbing & Mechanical Inspector", office: "(512) 974-2721", mobile: "(512) 228-2697", email: "chris.phillips@austintexas.gov" },
      { name: "Chad Watson", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 228-6146", email: "chad.watson@austintexas.gov" },
      { name: "Joe Parker", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 584-1797", email: "joe.parker@austintexas.gov" },
      { name: "Leonard Gonzales", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 299-7179", email: "leonard.gonzales@austintexas.gov" },
      { name: "Michelle Riffe", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 299-3857", email: "michelle.riffe@austintexas.gov" },
      { name: "Nelson Rivera", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 228-6486", email: "nelson.rivera-libran@austintexas.gov" },
      { name: "Phillip Cantrell", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 577-9501", email: "phillip.cantrell@austintexas.gov" },
      { name: "Philip Sughrue", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 293-6300", email: "philip.sughrue@austintexas.gov" },
      { name: "Rick Holloway", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 584-3149", email: "rick.holloway@austintexas.gov" },
      { name: "Tim Hooper", title: "Commercial Plumbing & Mechanical Inspector", office: "", mobile: "(512) 584-1170", email: "timothy.hooper@austintexas.gov" }], thirdParty: ["Veritas Inspections", "Crossroads Inspections", "Fox Energy Specialists"], warning: "Austin uses the UPC, not the IPC. Plumbing code is UPC 2021. Surrounding cities use the IPC. Always confirm before pulling a permit near Austin city limits." },
  ...
  "Burleson": { code: "IPC 2021", population: "50K", region: "North Texas (Fort Worth suburb)", amendments: ["NCTCOG regional amendments apply", "Johnson/Tarrant county line — verify which county governs your address", "Fire code review required before Fire Marshal submittal", "Thermal expansion tank required on all closed water systems"], inspector: "Burleson Building Permits & Inspections", phone: "(817) 426-9600", directLine: "(817) 426-9600", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "burlesontx.com/87/Building-Permits-Inspections", thirdParty: ["Crossroads Inspections", "Code Solutions Inc.", "Bureau Veritas"] },
  ...
  "McKinney": { code: "IPC 2024 ⚠", population: "222K", region: "North Texas", amendments: ["⚠ McKinney adopted IPC 2024 effective October 1, 2025", "⚠ IPC 2024 adopted effective October 1, 2025", "Recirculation required on hot water systems over 50 ft on new residential", "Water softener loop required on all new construction", "Dual check backflow required on all irrigation systems", "Underground gas: PE pipe only with tracer wire", "All inspections must be scheduled through Citizen Self Service (CSS)", "Cancel before 9AM: call (469) 617-4800 | After 9AM: call inspector directly", "Backflow test reports for all devices picked up by Plumbing Inspector at inspection"], inspector: "McKinney Building Inspections", phone: "(469) 617-4800", directLine: "(469) 617-4800", scheduleHours: "Mon–Fri 8AM–5PM | Sa 8AM–5PM | Su 1–5PM for inspections", permitRequired: true, permitUrl: "mckinneytexas.org/243/Building-Inspections", staffDirectory: "mckinneytexas.org/263/Notices — click Contact List/Org Chart", inspectorContacts: [{ name: "Building Inspections Main", title: "Permits & Inspections", office: "(469) 617-4800", email: "" }, { name: "Legacy Permit Line", title: "Forms & Code Questions", office: "(469) 617-4800", email: "" }, { name: "Fire Marshal Office", title: "Fire Code Questions", office: "(972) 547-2862", email: "fmo@mckinneytexas.org" }], thirdParty: ["Crossroads Inspections", "Master Code", "Bureau Veritas"] },
  ...
  "Waco": { code: "IPC 2021", population: "139K", region: "Central Texas", amendments: ["Model construction codes with local amendments", "Gas pressure test: 10 PSI minimum", "Thermal expansion tank required on all closed water systems", "CSST bonding required per NFPA 54"], inspector: "Waco Inspection Services", phone: "(254) 750-5630", directLine: "(254) 750-5630", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "wacotexas.gov/459/Development-Services", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Wichita Falls": { code: "IPC 2021", population: "102K", region: "North Texas", amendments: ["Permits and inspections through MGOconnect online portal", "After-hours and emergency inspections available", "All contractors must register and obtain code compliance bond", "Gas pressure test: 10 PSI minimum, witnessed test may be required"], inspector: "Wichita Falls Building Inspections", phone: "(940) 761-7442", directLine: "(940) 761-7442", scheduleHours: "Mon–Fri 8AM–5PM | After-hours available", permitRequired: true, permitUrl: "wichitafallstx.gov/284/Building-Inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Abilene": { code: "IPC 2021", population: "125K", region: "West Texas", amendments: ["All permits through Accela online portal", "Gas pressure test: 10 PSI minimum hold for 15 minutes", "Thermal expansion tank required on all closed water systems", "Water heater pan required in all interior locations"], inspector: "Abilene Building Inspections", phone: "(325) 676-6246", directLine: "(325) 676-6246", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "abilenetx.gov/531/Building-Inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Baytown": { code: "IPC 2021", population: "83K", region: "Greater Houston", amendments: ["Harris County border — verify jurisdiction before pulling permit", "Petrochemical area — additional gas line requirements may apply", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation and commercial connections"], inspector: "Baytown Building Inspections", phone: "(281) 420-5464", directLine: "(281) 420-5464", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "baytown.org/2029/Building-Inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Burgess Construction Consultants"] },
  "Beaumont": { code: "IPC 2021", population: "117K", region: "Southeast Texas", amendments: ["All permits through online portal", "Gas pressure test: 10 PSI for 30 minutes", "Thermal expansion tank required on all closed water systems", "Jefferson County rules apply in unincorporated areas"], inspector: "Beaumont Building Inspections", phone: "(409) 880-3763", directLine: "(409) 880-3763", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "beaumonttexas.gov/272/Building-Services", thirdParty: ["Bureau Veritas", "ECS Limited", "Texas Third Party Inspections LLC"] },
  "Boerne": { code: "IPC 2021", population: "22K", region: "San Antonio Suburb (Hill Country)", amendments: ["Hill Country — expansive soil conditions, granular bedding may be required", "Kendall County rules apply outside city limits", "Thermal expansion tank required on all water heater installs", "Water service connections require city utility pre-approval"], inspector: "Boerne Building Inspections", phone: "(830) 249-9511", directLine: "(830) 249-9511", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "boernetx.gov/permits", thirdParty: ["Roadrunner Inspections", "Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Duncanville": { code: "IPC 2021", population: "40K", region: "North Texas (DFW)", amendments: ["NCTCOG regional amendments apply", "Dallas County — permits required before work begins", "Thermal expansion tank required", "CSST bonding required per NFPA 54"], inspector: "Duncanville Building Inspections", phone: "(972) 780-5000", directLine: "(972) 780-5000", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "duncanville.com/488/Building-Inspections", thirdParty: ["Crossroads Inspections", "Bureau Veritas"] },
  "Edinburg": { code: "IPC 2021", population: "101K", region: "Rio Grande Valley", amendments: ["Hidalgo County seat — verify county rules for unincorporated areas", "High mineral content water — additional water heater protection recommended", "Backflow prevention required on all irrigation connections", "Gas pressure test: 10 PSI minimum"], inspector: "Edinburg Building Inspections", phone: "(956) 388-8203", directLine: "(956) 388-8203", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "edinburg.com/265/Permits", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  "Friendswood": { code: "IPC 2021", population: "40K", region: "Greater Houston", amendments: ["Galveston/Harris county line — verify which county governs your address", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation systems", "Gas pressure test: 10 PSI for 30 minutes"], inspector: "Friendswood Building Inspections", phone: "(281) 996-3200", directLine: "(281) 996-3200", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "friendswood.com/284/Permits-Inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas"] },
  "Harlingen": { code: "IPC 2024 ⚠", population: "65K", region: "Rio Grande Valley", amendments: ["Cameron County — verify county rules for unincorporated areas", "High mineral content water — water softener loop recommended on new construction", "Backflow prevention required on all irrigation connections", "Thermal expansion tank required on all closed water systems"], inspector: "Harlingen Building Inspections", phone: "(956) 216-5080", directLine: "(956) 216-5080", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "harlingentx.gov/departments/building_inspections/index.php", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  "Humble": { code: "IPC 2021", population: "16K", region: "Greater Houston", amendments: ["Harris County MUD rules commonly apply — verify jurisdiction", "Thermal expansion tank required", "Backflow prevention required on all irrigation systems", "Gas pressure test: 10 PSI for 30 minutes"], inspector: "Humble Building Inspections", phone: "(281) 446-4661", directLine: "(281) 446-4661", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "cityofhumble.com/building-inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Burgess Construction Consultants"] },
  "Huntsville": { code: "IPC 2021", population: "43K", region: "East Texas (Sam Houston area)", amendments: ["Walker County seat — verify county rules for unincorporated areas", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold", "Water heater pan required in all interior locations"], inspector: "Huntsville Building Inspections", phone: "(936) 291-5415", directLine: "(936) 291-5415", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "huntsvilletx.gov/189/Building-Permits-Inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Joshua": { code: "IPC 2021", population: "8K", region: "North Texas (Fort Worth suburb)", amendments: ["Johnson County — verify ETJ boundaries", "NCTCOG regional amendments apply", "Thermal expansion tank required", "Gas pressure test required — document results"], inspector: "Joshua Building Department", phone: "(817) 558-7447", directLine: "(817) 558-7447", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "joshuatx.gov/permits", thirdParty: ["Code Solutions Inc.", "Bureau Veritas"] },
  ...
  "Marshall": { code: "IPC 2021", population: "22K", region: "East Texas", amendments: ["Harrison County seat", "Permits required for all plumbing work including water heater replacements", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Marshall Building Inspections", phone: "(903) 935-4450", directLine: "(903) 935-4450", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "marshalltexasgov.com/permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Missouri City": { code: "IPC 2021", population: "75K", region: "Greater Houston", amendments: ["Fort Bend County — verify MUD district rules", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation systems", "Gas pressure test: 10 PSI for 30 minutes"], inspector: "Missouri City Building Inspections", phone: "(281) 403-8700", directLine: "(281) 403-8700", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "missouricitytx.gov/177/Building-Permits-Inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Burgess Construction Consultants"] },
  "Mount Pleasant": { code: "IPC 2021", population: "17K", region: "Northeast Texas", amendments: ["Titus County seat", "Permits required for all plumbing work", "Gas pressure test: 10 PSI minimum hold", "Thermal expansion tank required on all closed water systems"], inspector: "Mount Pleasant Building Inspections", phone: "(903) 575-4000", directLine: "(903) 575-4000", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "mountpleasanttx.com/190/Building-Inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Nacogdoches": { code: "IPC 2021", population: "33K", region: "East Texas (Deep East Texas)", amendments: ["Stephen F. Austin University area — student housing codes enforced", "Nacogdoches Water utility approval required for new connections", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Nacogdoches Building Inspections", phone: "(936) 559-2571", directLine: "(936) 559-2571", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "ci.nacogdoches.tx.us/government/departments/building_inspection", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "San Angelo": { code: "IPC 2021", population: "100K", region: "West Texas", amendments: ["Tom Green County seat — verify county rules for unincorporated areas", "Water conservation fixtures mandatory on all new construction", "Gas pressure test: 10 PSI minimum hold for 15 minutes", "Thermal expansion tank required on all closed water systems"], inspector: "San Angelo Building Inspections", phone: "(325) 657-4407", directLine: "(325) 657-4407", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "cosatx.gov/permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Sherman": { code: "IPC 2021", population: "44K", region: "North Texas (Texoma)", amendments: ["Grayson County seat", "NCTCOG regional amendments apply", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Sherman Building Inspections", phone: "(903) 892-7227", directLine: "(903) 892-7227", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "ci.sherman.tx.us/building-inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Stephenville": { code: "IPC 2021", population: "22K", region: "North Texas (Erath County)", amendments: ["Tarleton State University area", "Erath County — verify county rules for unincorporated areas", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Stephenville Building Department", phone: "(254) 918-1224", directLine: "(254) 918-1224", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "stephenvilletx.gov/government/departments/development-services", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Sulphur Springs": { code: "IPC 2021", population: "16K", region: "Northeast Texas", amendments: ["Hopkins County seat", "Permits required for all plumbing work", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Sulphur Springs Building Inspections", phone: "(903) 885-7541", directLine: "(903) 885-7541", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "sulphurspringstx.org/government/departments/planning-and-zoning", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Texarkana": { code: "IPC 2021", population: "37K", region: "Northeast Texas (Arkansas border)", amendments: ["Texas/Arkansas state line — confirm you are in the Texas jurisdiction", "Bowie County — verify county rules for unincorporated areas", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold for 15 minutes"], inspector: "Texarkana TX Building Inspections", phone: "(903) 798-3900", directLine: "(903) 798-3900", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "texarkanatexas.org/building", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"], warning: "Texarkana straddles the Texas/Arkansas state line. Always confirm your job address is on the Texas side before pulling a permit." },
  "Texas City": { code: "IPC 2024 ⚠", population: "51K", region: "Greater Houston (Galveston County)", amendments: ["Galveston County coastal area — corrosion protection required on exposed piping", "Wind-driven rain protection required on vent terminations", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all connections"], inspector: "Texas City Building Inspections", phone: "(409) 643-5600", directLine: "(409) 643-5600", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "texascity-tx.gov/164/Building-Inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas"] },
  "Victoria": { code: "IPC 2021", population: "67K", region: "South Texas (Crossroads)", amendments: ["Victoria County seat — verify county rules for unincorporated areas", "Thermal expansion tank required on all closed water systems", "Backflow prevention required on all irrigation connections", "Gas pressure test: 10 PSI minimum hold for 15 minutes"], inspector: "Victoria Building Inspections", phone: "(361) 485-3010", directLine: "(361) 485-3010", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "victoriatx.gov/190/Permits-Inspections", thirdParty: ["Bureau Veritas", "ECS Limited", "Texas Third Party Inspections LLC"] },
  ...
  "Wylie": { code: "IPC 2021", population: "60K", region: "North Texas (DFW)", amendments: ["NCTCOG regional amendments apply", "Collin County — verify ETJ for addresses near city limits", "Thermal expansion tank required", "CSST bonding required per NFPA 54"], inspector: "Wylie Building Inspections", phone: "(972) 516-6420", directLine: "(972) 516-6420", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "wylietexas.gov/departments/building_inspection/index.php", thirdParty: ["Crossroads Inspections", "Master Code", "Bureau Veritas"] },
  ...
  "Harker Heights": { code: "IPC 2021", population: "32K", region: "Central Texas (Fort Hood area)", amendments: ["Coryell/Bell county area — near Fort Cavazos", "Military community — verify civilian permit requirements vs on-base work", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Harker Heights Building Inspections", phone: "(254) 953-5635", directLine: "(254) 953-5635", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "harkertx.gov/216/Permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Galveston": { code: "IPC 2021", population: "53K", region: "Gulf Coast (Galveston County)", amendments: ["Coastal zone — all exposed piping must be corrosion resistant", "Wind-driven rain protection required on all vent terminations", "Elevated structure requirements — piping support on piers", "Flood zone: all water heaters and HVAC elevated above base flood elevation"], inspector: "Galveston Building Inspection Division", phone: "(409) 797-3660", directLine: "(409) 797-3660", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "galvestontx.gov/159/Development-Services", thirdParty: ["Bureau Veritas", "ECS Limited", "Texas Third Party Inspections LLC"], warning: "Galveston is a coastal flood zone. All plumbing equipment must be elevated above base flood elevation. Corrosion-resistant materials required on all exposed exterior piping." },
  "Dickinson": { code: "IPC 2021", population: "24K", region: "Greater Houston (Galveston County)", amendments: ["Galveston County coastal area", "Flood zone considerations — verify base flood elevation", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections"], inspector: "Dickinson Building Inspections", phone: "(281) 337-6200", directLine: "(281) 337-6200", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "dickinsontexas.gov/1054/Permits-Applications", thirdParty: ["Fox Energy Specialists", "Bureau Veritas"] },
  ...
  "Angleton": { code: "IPC 2021", population: "19K", region: "Greater Houston (Brazoria County)", amendments: ["Brazoria County seat", "Verify MUD district rules if working in unincorporated areas", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Angleton Building Department", phone: "(979) 849-4364", directLine: "(979) 849-4364", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "angletontx.com/169/Building-Inspections", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Burgess Construction Consultants"] },
  "Nederland": { code: "IPC 2021", population: "17K", region: "Southeast Texas (Jefferson County)", amendments: ["Jefferson County — industrial area near Port Arthur", "Petrochemical corridor — gas line requirements strictly enforced", "Thermal expansion tank required on all closed water systems", "Backflow prevention required on all connections"], inspector: "Nederland Building Inspections", phone: "(409) 723-1503", directLine: "(409) 723-1503", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "ci.nederland.tx.us/197/Building-Inspections", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  "Lumberton": { code: "IPC 2021", population: "14K", region: "Southeast Texas (Hardin County)", amendments: ["Hardin County — growing suburban area", "Verify county vs city jurisdiction on permits", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Lumberton Building Department", phone: "(409) 755-0581", directLine: "(409) 755-0581", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "cityoflumberton.com/276/Building-Permits", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  ...
  "Midlothian": { code: "IPC 2021", population: "38K", region: "North Texas (Ellis County)", amendments: ["Fast-growing Ellis County suburb", "NCTCOG regional amendments apply", "Thermal expansion tank required on all closed water systems", "Underground plastic sewer requires tracer wire"], inspector: "Midlothian Building Inspections", phone: "(972) 775-7120", directLine: "(972) 775-7120", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "midlothian.tx.us/74/Building-Permits-Inspections", thirdParty: ["Crossroads Inspections", "Code Solutions Inc.", "Bureau Veritas"] },
  "Red Oak": { code: "IPC 2021", population: "16K", region: "North Texas (Ellis County)", amendments: ["Ellis County growing suburb south of Dallas", "NCTCOG regional amendments apply", "Thermal expansion tank required", "Gas pressure test: 10 PSI minimum hold"], inspector: "Red Oak Building Inspections", phone: "(972) 617-3638", directLine: "(972) 617-3638", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "redoaktx.org/318/Residential-Building-Permit", thirdParty: ["Crossroads Inspections", "Bureau Veritas"] },
  ...
  "Corsicana": { code: "IPC 2021", population: "23K", region: "North Texas (Navarro County)", amendments: ["Navarro County seat", "Verify county rules for addresses outside city limits", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Corsicana Building Department", phone: "(903) 654-4800", directLine: "(903) 654-4800", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "corsicanatx.gov/226/Building-Inspection", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Athens": { code: "IPC 2021", population: "13K", region: "East Texas (Henderson County)", amendments: ["Henderson County seat", "East Texas expansive soil — granular bedding under slab recommended", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum"], inspector: "Athens Building Department", phone: "(903) 675-2341", directLine: "(903) 675-2341", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "athenstx.gov/building-inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Jacksonville": { code: "IPC 2021", population: "14K", region: "East Texas (Cherokee County)", amendments: ["Cherokee County seat", "Verify county rules if working outside city limits", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Jacksonville Building Department", phone: "(903) 586-1511", directLine: "(903) 586-1511", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "jacksonvilletx.gov/232/Building-Permits-Inspections", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Leander": { code: "IPC 2021", population: "75K", region: "Central Texas (Williamson County)", amendments: ["One of fastest-growing cities in Texas — high permit volume", "Williamson County — verify ETJ before pulling permit", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections", "Two free inspections per permit; additional reinspections $75 each"], inspector: "Leander Building Inspections", phone: "(512) 528-2752", directLine: "(512) 528-2752", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "leandertx.gov/266/Building-Inspections", thirdParty: ["Fox Energy Specialists", "Crossroads Inspections", "Bureau Veritas"] },
  "Pflugerville": { code: "IPC 2021", population: "75K", region: "Central Texas (Travis/Williamson County)", amendments: ["Travis/Williamson county line — verify which county and district governs your address", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections", "High permit volume — schedule inspections well in advance"], inspector: "Pflugerville Building Department", phone: "(512) 990-6100", directLine: "(512) 990-6100", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "cityofpflugerville.com/permits", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Crossroads Inspections"] },
  "Rowlett": { code: "IPC 2021", population: "67K", region: "North Texas (Dallas/Rockwall County line)", amendments: ["NCTCOG regional amendments apply", "Dallas/Rockwall county line — verify jurisdiction for addresses near city limits", "Thermal expansion tank required on all closed water systems", "CSST bonding required per NFPA 54"], inspector: "Rowlett Building Inspections", phone: "(972) 412-6100", directLine: "(972) 412-6100", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "rowletttx.gov/222/Permits", thirdParty: ["Crossroads Inspections", "Master Code", "Bureau Veritas"] },
  "Odessa": { code: "IPC 2021", population: "120K", region: "West Texas (Ector County)", amendments: ["Permian Basin jurisdiction — high commercial/industrial activity", "Oilfield equipment connections require separate commercial permit review", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum for 15 minutes — document start and end PSI"], inspector: "Odessa Building Permits", phone: "(432) 335-3260", directLine: "(432) 335-3260", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "odessatx.gov/permits", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  "Nacogdoches": { code: "IPC 2021", population: "35K", region: "East Texas (Nacogdoches County)", amendments: ["East Texas deep Piney Woods jurisdiction", "Septic systems common in county areas — verify sewer connection before permit", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections"], inspector: "Nacogdoches Building Department", phone: "(936) 559-2573", directLine: "(936) 559-2573", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "ci.nacogdoches.tx.us/government/departments/building_inspection", thirdParty: ["Texas Third Party Inspections LLC", "Bureau Veritas"] },
  "Texarkana": { code: "IPC 2021", population: "37K (TX side)", region: "Northeast Texas (Bowie County)", amendments: ["Dual-state metro — Texarkana TX and Texarkana AR operate under different codes", "Texas side uses IPC 2021; confirm job address is in TX jurisdiction", "Thermal expansion tank required on all closed water systems", "Gas pressure test required — document results"], inspector: "Texarkana Texas Building Department", phone: "(903) 798-3935", directLine: "(903) 798-3935", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "texarkanatexas.org/building", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  "Sherman": { code: "IPC 2021", population: "47K", region: "North Texas (Grayson County)", amendments: ["Grayson County — Texas Instruments semiconductor campus driving rapid growth", "High permit volume 2024–2026 due to major industrial expansion", "NCTCOG regional amendments apply", "Thermal expansion tank required on all closed water systems"], inspector: "Sherman Building Inspections", phone: "(903) 892-7227", directLine: "(903) 892-7227", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "ci.sherman.tx.us/building-inspections", thirdParty: ["Crossroads Inspections", "Master Code", "Bureau Veritas"] },
  "Lufkin": { code: "IPC 2021", population: "36K", region: "East Texas (Angelina County)", amendments: ["East Texas Piney Woods — Angelina County seat", "Septic systems common outside city limits — verify before pulling permit", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on irrigation connections"], inspector: "Lufkin Building Department", phone: "(936) 633-0217", directLine: "(936) 633-0217", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "cityoflufkin.com/permits", thirdParty: ["Texas Third Party Inspections LLC", "Bureau Veritas"] },
  "San Marcos": { code: "IPC 2021", population: "68K", region: "Central Texas (Hays County)", amendments: ["IPC 2021 adopted — previously used UPC, verify code edition for permits pulled before 2022", "Hays County growth corridor between Austin and San Antonio", "Edwards Aquifer recharge zone — special requirements for any underground work near recharge features", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections"], inspector: "San Marcos Building & Development Services", phone: "(512) 393-8150", directLine: "(512) 393-8150", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "sanmarcostx.gov/permits", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Crossroads Inspections"] },
  "Seguin": { code: "IPC 2021", population: "32K", region: "South Central Texas (Guadalupe County)", amendments: ["Guadalupe County — between San Antonio and New Braunfels", "High residential growth from San Antonio metro expansion", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections"], inspector: "Seguin Building Department", phone: "(830) 401-2432", directLine: "(830) 401-2432", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "seguintexas.gov/permits", thirdParty: ["ARC Inspections", "Bureau Veritas", "Crossroads Inspections"] },
...
const THIRD_PARTY = {
  ...
  "ARC Inspections": { strictAreas: ["Gas pressure testing — requires witnessed test with documented start/end PSI logged on their form", "Water heater installations — verify elevation, strapping, TPR discharge, and expansion tank before calling", "Plumbing top-out — all vent terminations measured from roof deck, clearances to HVAC intakes checked", "Shower pan liner flood test — must be witnessed by ARC inspector, 24-hour minimum hold required"], tips: ["Operates primarily in the San Antonio metro and surrounding areas including Boerne and New Braunfels", "Schedule inspections minimum 24 hours in advance — same-day not available", "Bring written material spec sheets on first inspection — they verify listed materials", "Common fail: expansion tank missing or not pre-charged to system pressure"], builders: ["DR Horton San Antonio", "Lennar San Antonio", "Perry Homes San Antonio"], region: "San Antonio Metro, Hill Country" },
  "Bilt-Rite Inspections": { strictAreas: ["Foundation plumbing slope — measured on every accessible run with a digital level before slab pour", "CSST bonding — requires bond clamp AND wire size documented on inspection report", "Sewer main cleanout location — must be within 10 feet of building foundation connection", "Thermal expansion tank — pre-charge pressure verified against PRV setting before sign-off"], tips: ["Houston metro specialist — primary service area Harris, Fort Bend, and Brazoria counties", "Call (281) area code offices; schedule inspections via their online portal", "Common fail: sewer cleanout more than 10 feet from the foundation connection point", "They use digital inspection reports — you will receive an emailed report same day"], builders: ["Beazer Homes Houston", "Gehan Homes", "Westin Homes"], region: "Houston Metro (Harris, Fort Bend, Brazoria counties)" },
  "Guardian Building Inspections": { strictAreas: ["Commercial plumbing — ADA fixture clearance compliance verified at rough-in, not just final", "Grease interceptor sizing calculations — require written DFU worksheet submitted with permit", "RPZ backflow assemblies — annual test certification required before they issue commercial final", "Fire suppression/plumbing coordination — they inspect wet pipe systems at the same time as domestic plumbing top-out"], tips: ["Primarily commercial projects across DFW — some residential in Collin and Denton counties", "Submit complete documentation package before scheduling — incomplete submittals are rejected", "Common fail: ADA lavatory clearance — centerline not 18 inches from side obstruction", "Used heavily by restaurant and commercial kitchen developers in DFW"], builders: ["Commercial restaurant developers", "Retail chain construction managers", "Medical facility contractors"], region: "DFW Metro (commercial focus)" },
  "Lone Star Inspection Services": { strictAreas: ["New construction phase inspections — foundation, rough-in, top-out, and final each require separate scheduled visits", "PEX-A vs PEX-B material verification — Dallas amendment requiring PEX-A in-slab strictly enforced", "Isolation valve at every fixture — they check every single fixture supply connection on final", "Gas line pressure test — witnessed test required, no self-certification accepted"], tips: ["DFW residential specialist — operates primarily in Dallas, Tarrant, Collin, and Denton counties", "Online scheduling portal — book at least 48 hours out for planned inspections", "Common fail: PEX-B found in slab in Dallas jurisdiction — must be PEX-A per Dallas amendment", "They provide photo documentation in digital reports — useful for your own records"], builders: ["First Texas Homes", "Impression Homes", "Dunhill Homes"], region: "DFW Metro (residential focus)" },
...
const REGIONAL_SUPPLIERS = {
  ...
  "Corpus Christi": [
    { name: "Moore Supply Co. - Corpus Christi", phone: "(361) 826-3240", address: "2401 S Port Ave, Corpus Christi TX 78405", url: "mooresupply.com", specialty: "Full-line plumbing, coastal-rated materials" },
...
function AppInner() {
  ...
  const doAuth = async (action) => {
    ...
    try {
      ...
      if (!data.success) { setAuthError(data.error || "Something went wrong"); }
        ...
        try {
          // Reset usage if different email logs in
          const prevEmail = localStorage.getItem('codex_email');
          if (prevEmail !== data.user.email) localStorage.removeItem('codex_usage');
          localStorage.setItem('codex_authed', 'true');
          localStorage.setItem('codex_user', JSON.stringify(data.user));
          localStorage.setItem('codex_email', data.user.email);
        } catch(e) {}
  ...
  useEffect(() => {
    ...
    if (hash && hash.includes("access_token")) {
      ...
      if (token) {
        ...
        try {
          const prevEmail = localStorage.getItem('codex_email');
          if (prevEmail !== email) localStorage.removeItem('codex_usage');
          localStorage.setItem('codex_authed', 'true');
          localStorage.setItem('codex_user', JSON.stringify({ email }));
          localStorage.setItem('codex_email', email);
        } catch(e) {}
  ...
  // Handles both touch momentum and mouse wheel scroll position
  useEffect(() => {
    const cnt = cntRef.current;
    if (!cnt) return;
    // Immediate reset
    cnt.scrollTop = 0;
    // Double rAF for touch momentum (iOS)
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        cnt.scrollTop = 0;
      });
    });
    // setTimeout safety net for mouse/trackpad scroll position
    const t1 = setTimeout(() => { if (cnt) cnt.scrollTop = 0; }, 50);
    const t2 = setTimeout(() => { if (cnt) cnt.scrollTop = 0; }, 150);
  ...
  const unlockAudio = () => {
    try {
      // Reuse the SAME audioRef element — iOS only trusts audio played during the user gesture
  ...
  const speak = async (text, enText, esText) => {
    ...
    try {
      ...
      if (data.audioContent) {
        ...
        try { window.speechSynthesis.cancel(); } catch(e) {}
        try { window.speechSynthesis.cancel(); } catch(e) {}
        // Reuse the already-unlocked audioRef element — critical for iOS autoplay
        if (!audioRef.current) audioRef.current = new Audio();
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          ...
          <div style={{ fontFamily: "'Lora',serif", fontSize: 14, color: "#6a8a9a", lineHeight: 1.6 }}>
            {tier === "free" && ["inspectors","identify","jobmode","estimate"].includes(upgradeFeature)
              ? `${upgradeFeature === "inspectors" ? "Inspector profiles" : upgradeFeature === "identify" ? "Bob identifier" : upgradeFeature === "jobmode" ? "Job mode" : "Estimates"} require Pro. Basic does not include this feature.`
              : tier === "free"
