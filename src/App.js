...
const JURISDICTIONS = {
  ...
  "Texas City": { code: "IPC 2021", population: "51K", region: "Greater Houston (Galveston County)", amendments: ["Galveston County coastal area — corrosion protection required on exposed piping", "Wind-driven rain protection required on vent terminations", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all connections"], inspector: "Texas City Building Inspections", phone: "(409) 643-5600", directLine: "(409) 643-5600", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "texascity-tx.gov/government/departments/building_inspections_and_permits", thirdParty: ["Fox Energy Specialists", "Bureau Veritas"] },
  ...
  "Leander": { code: "IPC 2021", population: "75K", region: "Central Texas (Williamson County)", amendments: ["One of fastest-growing cities in Texas — high permit volume", "Williamson County — verify ETJ before pulling permit", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections", "Two free inspections per permit; additional reinspections $75 each"], inspector: "Leander Building Inspections", phone: "(512) 528-2752", directLine: "(512) 528-2752", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "leandertx.gov/permits", thirdParty: ["Fox Energy Specialists", "Crossroads Inspections", "Bureau Veritas"] },
  "Pflugerville": { code: "IPC 2021", population: "75K", region: "Central Texas (Travis/Williamson County)", amendments: ["Travis/Williamson county line — verify which county and district governs your address", "Thermal expansion tank required on all water heater installs", "Backflow prevention required on all irrigation connections", "High permit volume — schedule inspections well in advance"], inspector: "Pflugerville Building Department", phone: "(512) 990-6100", directLine: "(512) 990-6100", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "pflugervilletx.gov/permits", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Crossroads Inspections"] },
