...
const JURISDICTIONS = {
  ...
  "Harlingen": { code: "IPC 2021", population: "65K", region: "Rio Grande Valley", amendments: ["Cameron County — verify county rules for unincorporated areas", "High mineral content water — water softener loop recommended on new construction", "Backflow prevention required on all irrigation connections", "Thermal expansion tank required on all closed water systems"], inspector: "Harlingen Building Inspections", phone: "(956) 216-5080", directLine: "(956) 216-5080", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "harlingentx.gov/permits", thirdParty: ["Bureau Veritas", "ECS Limited"] },
  ...
  "Mount Pleasant": { code: "IPC 2021", population: "17K", region: "Northeast Texas", amendments: ["Titus County seat", "Permits required for all plumbing work", "Gas pressure test: 10 PSI minimum hold", "Thermal expansion tank required on all closed water systems"], inspector: "Mount Pleasant Building Inspections", phone: "(903) 575-4000", directLine: "(903) 575-4000", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "mountpleasanttx.com/permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Harker Heights": { code: "IPC 2021", population: "32K", region: "Central Texas (Fort Hood area)", amendments: ["Coryell/Bell county area — near Fort Cavazos", "Military community — verify civilian permit requirements vs on-base work", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Harker Heights Building Inspections", phone: "(254) 953-5635", directLine: "(254) 953-5635", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "harlingentx.gov/permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
  ...
  "Angleton": { code: "IPC 2021", population: "19K", region: "Greater Houston (Brazoria County)", amendments: ["Brazoria County seat", "Verify MUD district rules if working in unincorporated areas", "Thermal expansion tank required on all closed water systems", "Gas pressure test: 10 PSI minimum hold"], inspector: "Angleton Building Department", phone: "(979) 849-4364", directLine: "(979) 849-4364", scheduleHours: "Mon-Fri 8AM-5PM", permitRequired: true, permitUrl: "angletontx.com/permits", thirdParty: ["Fox Energy Specialists", "Bureau Veritas", "Burgess Construction Consultants"] },
  ...
  "Texarkana": { code: "IPC 2021", population: "37K (TX side)", region: "Northeast Texas (Bowie County)", amendments: ["Dual-state metro — Texarkana TX and Texarkana AR operate under different codes", "Texas side uses IPC 2021; confirm job address is in TX jurisdiction", "Thermal expansion tank required on all closed water systems", "Gas pressure test required — document results"], inspector: "Texarkana Texas Building Department", phone: "(903) 798-3935", directLine: "(903) 798-3935", scheduleHours: "Mon–Fri 8AM–5PM", permitRequired: true, permitUrl: "texarkanatexas.org/permits", thirdParty: ["Bureau Veritas", "Texas Third Party Inspections LLC"] },
...
function AppInner() {
  ...
  // Double rAF ensures React has finished rendering the new content before we scroll
  useEffect(() => {
